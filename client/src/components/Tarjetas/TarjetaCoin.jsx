            ...
            <div className="card">
              <div className="flip">
                ...
                <div className="back">
                  ...
                  <div className="terms">
                    <p>
                      Esta tarjeta es propiedad de No Country Coin. El mal uso
                      es delito. Si lo encuentra, devuélvalo al banco más
                      cercano con el logotipo de MasterCard.
                    </p>
                    <p>
                      El uso de esta tarjeta está sujeto al acuerdo de la
                      tarjeta de crédito.
                    </p>
                  </div>
                </div>
